...
async function fetchUserData(identifier) {
	...
	if (data.records.length > 0) {
		...
		document.getElementById('master-class-status').innerText = userRecord['Master Class Status'] || 'Not available';
		document.getElementById('locals-member-type').innerText = userRecord['Locals Member Type'] || 'Not available';
		document.getElementById('slick-text').innerText = userRecord['Slick Text'] || 'Not available';
	} else {
		...
		document.getElementById('master-class-status').innerText = 'Not available';
		document.getElementById('locals-member-type').innerText = 'Not available';
		document.getElementById('slick-text').innerText = 'Not available';
	}
}
